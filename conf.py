...
html_theme_options = {
    ...
    'navbar_title': "Purpose-First Introduction to APIs and Requests",
...
html_title = 'Purpose-First Introduction to APIs and Requests'
...
from custom_components import plan_display, random_number_box, planful_worked_example, changeable_areas_display, fill_in_the_blank, highlighted_textbox
